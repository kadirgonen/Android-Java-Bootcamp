...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //https://api.nomics.com/v1/currencies/ticker?key=d29b1dc647c5bf3c69bfd6288f3d79426293513f
    ...
    private void loadData(){
        ...
        compositeDisposable.add(cryptoAPI.getData().subscribeOn(Schedulers.io())
